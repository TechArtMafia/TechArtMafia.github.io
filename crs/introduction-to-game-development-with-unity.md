...
You'll want to check out [what you'll need to bring](what-you-ll-need.md.md). 

The [Course Description](course-description.md.md) page covers the basics of what the class is about. The [Course Outline](course-outline.md.md) page contains lines to the notes for each week of the 6-week session.  There's also a page of [useful resources](resources--2.md.md) which can point you at online documentation and Q/A forums. If you're trying to learn all the buzzwords there's a [glossary](glossary.md) of common Unity terms
